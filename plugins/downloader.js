  ...
  async (m, channelName) => {
    try {
      ...
      if (!channels || !Array.isArray(channels) || channels.length === 0) {
        return await m.send("*_No channels found man!_*");
      }
...
`;
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `ã *KERM_MD-V2 MEDIAFIRE DOWNLOADER* ã\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     } else if (_0x5b8ee5[0].includes("KERM-MD_V2 YOUTUBE DOWNLOADER")) {
